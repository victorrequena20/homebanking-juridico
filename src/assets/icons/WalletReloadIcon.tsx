...
const WalletReloadIcon = ({ size, color }: Props) => {
  return (
    <svg width={size || 24} height={size || 24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M7 12H14" stroke={color || "#DFDFEC"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path
...
export default WalletReloadIcon;
